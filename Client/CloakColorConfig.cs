...
namespace HornetCloakColor.Client
{
    ...
    internal class CloakColorConfig
    {
        ...
        /// <summary>Cloak color after <see cref="HornetCloakColorInterop.ModifyLocalCloakColorBeforeApply"/> hooks.</summary>
        public CloakColor EffectiveColor => HornetCloakColorInterop.ApplyCloakColorModifiers(CurrentColor);

        /// <summary>Shared preset table (used by username colors when matching cloak presets).</summary>
        internal static CloakColor ResolvePresetColor(Preset preset, string customHex) =>
            Resolve(preset, customHex);
